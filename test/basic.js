...
assert.deepEqual(convert.rgb2hex([92, 191, 84]), '5CBF54');
...
assert.deepEqual(convert.hsl2hex([240, 100, 50]), '0000FF');
...
assert.deepEqual(convert.hsv2hex([251, 80, 42]), '25156B');
...
assert.deepEqual(convert.cmyk2hex([30, 0, 50, 22]), '8BC763');
...
assert.deepEqual(convert.keyword2hex('blue'), '0000FF');
...
assert.deepEqual(convert.hex2rgb('ABCDEF'), [171, 205, 239]);
...
assert.deepEqual(convert.hsl2hex(val), '000000');
